...
DROP DATABASE IF EXISTS proyectoIndividual;


CREATE DATABASE proyectoIndividual CHARACTER SET utf8 COLLATE utf8_general_ci;
...
GRANT ALL PRIVILEGES ON proyectoIndividual.* TO 'admin'@'localhost';
